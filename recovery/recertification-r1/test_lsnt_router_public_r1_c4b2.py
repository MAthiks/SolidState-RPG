...
def run():
    ...
    rt.close()
    report={'schema':'SOLIDSTATE_R1_C4B2_LSNT_V1_5_PUBLIC_TEST_V1','result':'PASS','passed':len(checks),'total':len(checks),'scope':'exact source identity contract + source-backed v1.5 multiplayer route + private-source fail-closed'}
