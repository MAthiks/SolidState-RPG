...
INTEGRATION_ID = "SOLIDSTATE_RECOVERY_RUNTIME_R1_C4B2_LSNT_V1"
SAVE_SCHEMA = "SOLIDSTATE_RECOVERY_SAVE_R1_C4B2_LSNT_V1"
AUTHORITY_ID = "RECOVERY_RECERTIFICATION_R1_C4B2_LSNT"
...
class SourceBackedRuntimeR1C4B2LSNT(SourceBackedRuntimeR1C4B):
    ...
    def new_canonical_session(self, scenario_key, players, session_id="R1-C4B2-LSNT-SESSION"):
        result = super().new_canonical_session(scenario_key, players, session_id)
        if result.get("status") != "SCENARIO_SESSION_READY":
            return result
    ...
    def restore_bundle(self, bundle):
        ...
        try:
            ...
            routed = resolve_route_c4b2(scenario.get("scenario_key", ""), self.source_paths)
